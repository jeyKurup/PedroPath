...
@Autonomous(name = "BLUE Inside 3Gate+2Stack", group = "blue", preselectTeleOp = "TeleOp BLUE Decode Drive Game")
public class BlueInsideTwoStackWithThreeGateOpen extends OpMode implements DriveParams {
