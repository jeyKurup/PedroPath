...
@Autonomous(name = "RED Inside 2Gate+3Stack", group = "red", preselectTeleOp = "TeleOp RED Decode Drive Game")
public class RedInsideThreeStackWithTwoGateOpen extends OpMode implements DriveParams {
