...
@TeleOp(name = "Robot Align RED Outside", group = "Calibration")
public class TeleOpSetRobotPositionRedOutside extends OpMode implements DriveParams {
    // Create an instance of the sensor
    GoBildaPinpointDriver pinpoint;
    private Servo alignInd = null;
    private Limelight3A limelight;
    private final int tagID = 24;
    @Override
    public void init() {
    ...
    public void loop() {
        ...
        if (gamepad1.a) {
            ...
            pinpoint.setPosition(new Pose2D(DistanceUnit.INCH, 77.878, 8.376, AngleUnit.DEGREES, 90));
        }
        pinpoint.update();
