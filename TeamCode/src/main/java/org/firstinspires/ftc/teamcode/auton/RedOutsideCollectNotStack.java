...
@Autonomous(name = "Red Outside Collect-NO Stack", group = "red", preselectTeleOp = "TeleOp RED Decode Drive Game")
public class RedOutsideCollectNotStack extends OpMode implements DriveParams {
    ...
    private final Pose collectaPose = new Pose(76.01, 24.253, Math.toRadians(140));
    private final Pose collectbPose = new Pose(119.881, 17.603, Math.toRadians(140));//21.264 21.679
    private final Pose collectcPose = new Pose(136.938, 28.6, Math.toRadians(140));
    private final Pose collectdPose = new Pose(133.745, 6.914, Math.toRadians(140));

    private final Pose collectRetaPose = new Pose(106.051, 16.569, Math.toRadians(140));
    private final Pose collectRetbPose = new Pose(89.835, 14.704, Math.toRadians(140));
    private final Pose endPose = new Pose(90,30, Math.toRadians(66.5));
